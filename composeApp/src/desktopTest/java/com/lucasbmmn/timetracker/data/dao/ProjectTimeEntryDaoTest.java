...
class ProjectTimeEntryDaoTest {
    private final DatabaseManager dbManager = new DatabaseManager();
    private final ProjectTimeEntryDao dao = new ProjectTimeEntryDao();
    ...
    private final ProjectTimeEntry ENTRY1 = new ProjectTimeEntry(
    ...
    private final ProjectTimeEntry ENTRY2 = new ProjectTimeEntry(
    ...
    void getAll() {
        ...
        dao.insert(ENTRY1);
        dao.insert(ENTRY2);
        List<ProjectTimeEntry> entries = dao.getAll();
    ...
    void update() {
        ...
        ProjectTimeEntry updatedEntry1 = new ProjectTimeEntry(ENTRY1.getUuid(), PROJECT2, Duration.ofSeconds(5400), new Date(), false);
        ProjectTimeEntry updatedEntry2 = new ProjectTimeEntry(ENTRY2.getUuid(), PROJECT1, Duration.ofSeconds(9000), new Date(), true);
